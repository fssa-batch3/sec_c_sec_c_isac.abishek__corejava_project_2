package com.fssa.product.model;
...
public class Product {
    ...
    private Date productRegisteredDateSQL; // This appears to be a SQL-specific date representation.
    private String imageUrl;

  

    // hashCode() and equals() methods to support comparison based on productName property
    @Override
    public int hashCode() {
    ...
    public void setProductRegisteredDate(Date date) {
        this.productRegisteredDateSQL = date;
    }
}
