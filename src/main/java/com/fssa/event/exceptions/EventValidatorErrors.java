 ...
 * These error messages can be used to identify specific issues when validating event-related data.
 */
public interface EventValidatorErrors {
    ...
    /**
     * Represents an error message for cases where the event name is invalid or empty.
     */
    public static final String INVALID_EVENT_NAME = "Event Name Invalid or empty";

    /**
     * Represents an error message for cases where the event ID is less than or equal to 0.
     */
    public static final String INVALID_EVENT_ID = "Event ID must be greater than 0";

    /**
     * Represents an error message for cases where the organizer name is null or empty.
     */
    ...
    /**
     * Represents an error message for cases where the event location is null or empty.
     */
