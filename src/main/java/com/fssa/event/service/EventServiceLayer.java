...
public class EventServiceLayer {
    ...
    // Instance variables for EventValidator and EventDao
    public EventValidator eventValidator;
    public EventDao eventDao;

    // Constructor to initialize the service layer with EventValidator and EventDao instances.
    ...
    public Event findEventByName(String name)
            throws SQLException, DaoException, ValidatorInitializationException {
        if (name == null) {
            throw new IllegalArgumentException(DaoExceptionErrors.INVALID_INPUT);
        }
        if (EventValidator.validateEventName(name)) {
