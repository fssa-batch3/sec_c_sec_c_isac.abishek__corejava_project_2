...
class TestEventServiceLayer {
	...
	@Test
	void testServiceAdd() throws ValidatorInitializationException, SQLException, DaoException, IllegalArgumentException,
			ConnectionException {
	...
	@Test
	void testServiceAddNull() throws DaoException, IllegalArgumentException, ValidatorInitializationException,
	...
	@Test
	void testServiceUpdateNull() throws IllegalArgumentException, ValidatorInitializationException, SQLException,
			DaoException, ConnectionException {
		Event event1 = null;
		EventServiceLayer eventServiceLayer = getEventLayer();
		try {
	...
	@Test
	void testServiceUpdateInvalid() throws IllegalArgumentException, ValidatorInitializationException, SQLException,
			DaoException, ConnectionException {
		LocalDate input = LocalDate.of(2023, 10, 10);
		Event event1 = new Event("12345", "North Street, Taramani", "Organizer", "9751328805",
				"https://freeimage.host/i/HNRzLYJ.jpg", input, "Concert");
	...
	void testReadEvents() throws DaoException, SQLException, IllegalArgumentException, ValidatorInitializationException,
			ConnectionException {
		LocalDate input = LocalDate.of(2023, 10, 10);
		Event event1 = new Event("Balaji Event", ",Global info North Street, Taramani", "Freshtrust", "9751328805",
				"https://freeimage.host/i/HNRzLYJ.jpg", input, "Concert ");
		EventServiceLayer eventServiceLayer1 = getEventLayer();
	...
	@Test
	void testViewEvents() throws IllegalArgumentException, ValidatorInitializationException, SQLException, DaoException,
			ConnectionException {
		EventServiceLayer eventServiceLayer1 = getEventLayer();

		Assertions.assertNotNull(eventServiceLayer1.viewEvent());
		Logger.info(eventServiceLayer1.viewEvent());
	}
	...
	@Test
	void testServiceFindByNameNull() throws IllegalArgumentException, ValidatorInitializationException, SQLException,
			DaoException, ConnectionException {
		String event1 = null;
		EventServiceLayer eventServiceLayer = getEventLayer();
		try {
